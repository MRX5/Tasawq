    ...
    return BlocConsumer<ShopLayoutCubit, ShopLayoutStates>(
      listener: (context, state) {
        if (state is ChangeFavouritesSuccessState) {
          if (!state.favouritesModel.status!) {
            showToast(
                msg: state.favouritesModel.message!, state: ToastState.ERROR);
          }
        }
      ...
      builder: (context, state) {
        ...
        return ConditionalBuilder(
            ...
            fallback: (context) => (state is GetHomeDataErrorState || state is GetFavouritesErrorState) ?
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          Icon(Icons.favorite, color: lightGreen) : Icon(Icons
                              .favorite_outline,),
                        )
                      ],
                    ),
